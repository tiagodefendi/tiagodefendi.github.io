        ...
        <footer className="bg-neutral-900 text-neutral-200 py-12 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="space-y-2">
                    <h3 className="text-lg font-semibold mt-3">Contact</h3>
                ...
                <div className="space-y-3">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><Link href="https://linktr.ee/tiago_defendi" target="_blank" rel="noopener noreferrer" className="hover:underline">Link Tree</Link></li>
                    </ul>
                </div>
            </div>
